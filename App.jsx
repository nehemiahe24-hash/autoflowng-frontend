...
// ROOT
// ═══════════════════════════════════════════════════════════════
const BACKEND_URL = "https://autoflowng-backend-production.up.railway.app";
...
function LoginModal({ onClose }) {
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(4,6,15,0.92)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:9999,padding:"20px"}}>
      <div style={{background:"#0C1120",border:"1px solid rgba(255,255,255,0.08)",borderRadius:20,padding:"40px 32px",maxWidth:400,width:"100%",textAlign:"center"}}>
        <div style={{fontSize:40,marginBottom:16}}>🚀</div>
        <h2 style={{color:"#E8EEFF",fontSize:24,fontWeight:800,marginBottom:8,fontFamily:"'Syne',sans-serif"}}>Get Started Free</h2>
        <p style={{color:"rgba(232,238,255,0.5)",fontSize:15,marginBottom:32,lineHeight:1.6}}>3 days free trial. No credit card required. Sign in with Google to continue.</p>
        <button onClick={()=>{ window.location.href = BACKEND_URL + "/api/auth/google"; }} style={{width:"100%",background:"#fff",color:"#1a1a1a",border:"none",borderRadius:12,padding:"14px 24px",fontSize:16,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginBottom:16}}>
        ...
        <button onClick={onClose} style={{background:"transparent",border:"1px solid rgba(255,255,255,0.1)",color:"rgba(232,238,255,0.5)",borderRadius:10,padding:"10px 20px",fontSize:14,cursor:"pointer",width:"100%"}}>Cancel</button>
        <p style={{color:"rgba(232,238,255,0.3)",fontSize:12,marginTop:20}}>By continuing, you agree to our Terms of Service and Privacy Policy</p>
      </div>
    </div>
  );
}
